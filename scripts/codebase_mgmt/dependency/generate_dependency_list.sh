...
# ==============================================================================
#
#          FILE: generate_dependency_list.sh
#
#         USAGE: ./scripts/dependency/generate_dependency_list.sh
#
#   DESCRIPTION: This script generates a list of dependencies to update from
#                `flake_nix_urls_with_filenames.txt`.
#
# ==============================================================================
