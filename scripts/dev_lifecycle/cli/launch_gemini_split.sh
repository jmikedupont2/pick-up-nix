...
# ==============================================================================
#
#          FILE: launch_gemini_split.sh
#
#         USAGE: ./scripts/cli/launch_gemini_split.sh <task_file>
#
#   DESCRIPTION: This script splits the current terminal and launches the Gemini
#                CLI with a given task file.
#
# ==============================================================================
