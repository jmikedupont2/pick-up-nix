...
# ==============================================================================
#
#          FILE: launch_gemini_with_poetry_task.sh
#
#         USAGE: ./scripts/cli/launch_gemini_with_poetry_task.sh
#
#   DESCRIPTION: This script combines the functionality of `subtask.sh`
#                (running a command in a new tmux split) and `gemini_split.sh`
#                (launching Gemini CLI with a task file). It specifically
#                launches Gemini with `poetry_task.md`.
#
# ==============================================================================
