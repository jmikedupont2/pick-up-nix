...
# ==============================================================================
#
#          FILE: run_in_tmux_split.sh
#
#         USAGE: ./scripts/session/run_in_tmux_split.sh <job_script_path>
#
#   DESCRIPTION: This script launches a given job script in a new `tmux` split
#                window.
#
# ==============================================================================
