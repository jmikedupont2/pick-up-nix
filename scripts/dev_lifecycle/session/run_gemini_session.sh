...
# ==============================================================================
#
#          FILE: run_gemini_session.sh
#
#         USAGE: ./scripts/session/run_gemini_session.sh <asciinema_rec_file> <session_name> <task_file>
#
#   DESCRIPTION: This script runs the Gemini CLI within a `tmux` session,
#                optionally creating a new session or attaching to an existing
#                one. It's closely related to `start_development_session.sh`
#                (formerly `boot.sh`).
#
# ==============================================================================
...
#fi
GEMINI_INVOCATION="/data/data/com.termux.nix/files/home/nix/scripts/dev_lifecycle/ai/gemini/gemini_cli_new.sh"
