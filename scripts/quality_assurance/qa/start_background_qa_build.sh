...
# ==============================================================================
#
#          FILE: start_background_qa_build.sh
#
#         USAGE: ./scripts/qa/start_background_qa_build.sh [timeout] [strace] [verbose]
#
#   DESCRIPTION: This script starts the QA build process in the background
#                using `nohup` and `build_qa_process.sh`.
#
# ==============================================================================
