{
  ...
  outputs = { self, nixpkgs, nixpkgs-unstable, nix-on-droid, home-manager, naersk, flake-utils, rust-overlay,
              nixtract-src, nixpkgs-lint-src, streamofrandom, gemini-cli }@inputs:
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in
      {
        ...
        devShells.default = (builtins.import ./nix/devshells.nix { inherit lib nixpkgs pkgs; }).devShells.default;
      }
    );
}